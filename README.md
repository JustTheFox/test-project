...
* ```yarn bem create my-block``` - для создания папки БЭМ-блока, где ```my-block``` - имя БЭМ-блока
* ```yarn bem create my-component -l src/blocks/components``` для создания компонента
* ```yarn bem create my-component -l src/blocks/components && bem create my-block``` - создать всё вместе
